"""
Starter fabfile for deploying the sis project.
...
# CHANGEME
env.hosts = ['user@sis.example.com']
env.code_dir = '/srv/www/sis'
env.project_dir = '/srv/www/sis/sis'
env.static_root = '/srv/www/sis/static/'
env.virtualenv = '/srv/www/sis/.virtualenv'
env.code_repo = 'git@github.com:user/sis.git'
env.django_settings_module = 'sis.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/sis/wsgi.py" % env.code_dir)
